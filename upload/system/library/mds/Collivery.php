...
class Collivery {
    ...
    public function __construct(array $config = array(), $cache = null)
    {
        ...
        $this->config = (object) array(
            'app_name'      => 'MDS Open Cart', // Application Name
            'app_version'   => '1.0',            // Application Version
            'app_host'      => 'Open Cart' . VERSION, // Framework/CMS name and version, eg 'Wordpress 3.8.1 WooCommerce 2.0.20' / 'Joomla! 2.5.17 VirtueMart 2.0.26d'
    ...
    public function getTowns($country = "ZAF", $province = null)
    {
        ...
        } elseif (($this->check_cache == 2) && ! is_null($province) && $this->cache->has(
    ...
    {
        if (($this->check_cache == 2) && $this->cache->has(
    ...
    public function getAddresses(array $filter = array())
    {
        ...
        if (($this->check_cache == 2) && empty($filter) && $this->cache->has(
    ...
    public function addAddress(array $data)
    {
        ...
        if ( ! $this->hasErrors()) {
            try {
                ...
                return array('soap_exception' => $e->getMessage(), 'errors' => $this->errors);
            }
     ...
     * @return bool
     */
    public function validateGetPriceData(array $data = array())
    {
